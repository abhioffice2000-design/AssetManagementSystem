...
(function (window, $, undefined) {
  ...
  $.cordys.ajax = function (options) {
    ...
    opts.error = function (jqXHR, textStatus, errorThrown) {
      ...
      var messCode = '',
        failObj = (jqXHR && typeof jqXHR.fail === 'function') ? jqXHR.fail() : jqXHR,
        responseText = (failObj && failObj.responseText) ? failObj.responseText : '',
        responseXML = (failObj && failObj.responseXML) ? failObj.responseXML : null;
